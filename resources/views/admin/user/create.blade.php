            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="p-5">
                        ...
                        {!! Form::open(array('class' => 'user', 'route' => 'user.store','method'=>'POST', 'enctype'=>'multipart/form-data')) !!}
                        ...
                        <div class="col-sm-8 mb-3  ">
                            ...
                            <label for="title">Picture</label>
                             ...
                             <a class="btn btn-secondry float-right" href="{{ route('user.index') }}">Go Back to List</a>
